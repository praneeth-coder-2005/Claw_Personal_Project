...
<div class="movie-post" style="width: 100%; max-width: 800px; margin: 50px auto; background-color: #1a1a1a; border-radius: 10px; overflow: hidden; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.2); padding: 20px;">
  <!--Movie Header-->
  <div class="movie-header" style="display: flex; align-items: center; margin-bottom: 20px;">
    <!--Movie Poster (Visible Only Once Inside the Post)-->
    <img alt="Movie Poster" class="movie-poster" id="movie-poster" src="{poster_url}" style="width: 150px; height: 225px; border-radius: 8px; object-fit: cover; margin-right: 20px;" />

    <!--Movie Details Section-->
    <div class="movie-details" style="flex-grow: 1;">
      <h2 class="movie-title" id="movie-title" style="font-size: 24px; margin: 0; font-weight: bold; color: #fff;">{movie_title}</h2>
      <p class="release-date" id="release-date" style="font-size: 14px; margin: 5px 0;"><strong>Release Date:</strong> {release_date}</p>
      <p class="rating" id="rating" style="font-size: 14px; margin: 5px 0;"><strong>Rating:</strong> {rating}</p>
      <p class="genre" id="genre" style="font-size: 14px; margin: 5px 0;"><strong>Genre:</strong> {genre}</p>
      <p class="runtime" id="runtime" style="font-size: 14px; margin: 5px 0;"><strong>Runtime:</strong> {runtime}</p>
    </div>
  </div>

  <!--Movie Synopsis Section-->
  <div class="movie-description" style="margin-top: 30px;">
    <h3 style="font-size: 22px; color: #ff6f61; margin-bottom: 10px;">Synopsis</h3>
    <p id="movie-synopsis" style="font-size: 16px; line-height: 1.5; color: #ccc;">{synopsis}</p>
  </div>
